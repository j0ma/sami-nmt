...
export randseg_experiment_name=english2german_vanillabpe
...
export randseg_checkpoints_folder=./eng_deu_bin/sweep_randseg_ckpt_eng_deu_vanillabpe_${randseg_num_merges}mops_${randseg_random_seed}_temperature${randseg_temperature}_$(date +%s)
export randseg_binarized_data_folder=./eng_deu_bin/sweep_randseg_bindata_eng_deu_vanillabpe_${randseg_num_merges}mops_${randseg_random_seed}_temperature${randseg_temperature}_$(date +%s)
