...
export randseg_checkpoints_folder=./fin_sme_bin/own_bt_beam1_huge_checkpoints_$(date +%s)
export randseg_binarized_data_folder=./fin_sme_bin/own_bt_beam1_huge_bindata_$(date +%s)
export randseg_model_name=own_bt_beam1_huge
