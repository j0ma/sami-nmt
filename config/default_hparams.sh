...
export randseg_decoder_embedding_dim="200"
export randseg_decoder_hidden_size="1024"
export randseg_decoder_layers="4"
export randseg_encoder_attention_heads="8"
export randseg_encoder_embedding_dim="200"
export randseg_encoder_hidden_size="1024"
export randseg_encoder_layers="4"
...
export randseg_max_update="90"
export randseg_num_parallel_workers=4
export randseg_optimizer="adam"
export randseg_patience="3"
export randseg_p_dropout="0.2"
