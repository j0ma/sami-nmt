...
export randseg_checkpoints_folder=./sme_fin_bin/own_bt_best_checkpoints_$(date +%s)
export randseg_binarized_data_folder=./sme_fin_bin/own_bt_best_bindata_$(date +%s)
