...
export randseg_raw_data_folder=./data/eng-est/big
export randseg_source_language=eng
export randseg_target_language=est
export randseg_checkpoints_folder=./bin/sweep_randseg_ckpt_eng_est_vanillabpe_${randseg_num_merges}mops_${randseg_random_seed}_temperature${randseg_temperature}_$(date +%s)
export randseg_binarized_data_folder=./bin/sweep_randseg_bindata_eng_est_vanillabpe_${randseg_num_merges}mops_${randseg_random_seed}_temperature${randseg_temperature}_$(date +%s)
