...
export randseg_checkpoints_folder=./eng_uzb_binarized_data/sweep_randseg_ckpt_eng_uzb_randbpe_${randseg_num_merges}mops_${randseg_random_seed}_temperature${randseg_temperature}_$(date +%s)
export randseg_binarized_data_folder=./eng_uzb_binarized_data/sweep_randseg_bindata_eng_uzb_randbpe_${randseg_num_merges}mops_${randseg_random_seed}_temperature${randseg_temperature}_$(date +%s)
