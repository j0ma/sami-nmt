...
export randseg_new_eval_name=bt_sme2fin_wikipedia_unfiltered

export randseg_new_eval_raw_data_folder=${randseg_existing_train_folder}/raw_data/mono_to_bt_wikipedia_unfiltered
