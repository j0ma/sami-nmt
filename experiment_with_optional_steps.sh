...
main() {
    ...
    # These are optional
    test "${randseg_should_create_experiment}" = yes && create_experiment
    test "${randseg_should_preprocess}" = yes && preprocess
    test "${randseg_should_train}" = yes && train
    test "${randseg_should_evaluate}" = yes && \
