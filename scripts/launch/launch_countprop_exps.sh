...
parallel --jobs 4 "randseg_should_train=yes randseg_should_preprocess=yes randseg_should_create_experiment=yes launch_exp {1} {2} {3}" ::: finnish estonian german uzbek ::: 2k 5k 32k
